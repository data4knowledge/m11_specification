...
template = M11Template(filepath="source_data/2025-01-17/m11-template-spec.docx")
template.process()
template.rename_elements(filepath="source_data/2025-01-17/template_renames.yaml")
template.insert_elements(filepath="source_data/2025-01-17/template_inserts.yaml")
template.delete_elements(filepath="source_data/2025-01-17/template_deletes.yaml")
template.order_elements()
technical = M11Technical(filepath="source_data/2025-01-17/m11-technical-spec.docx")
technical.process()
technical.rename_elements(filepath="source_data/2025-01-17/technical_renames.yaml")
technical.delete_elements(filepath="source_data/2025-01-17/technical_deletes.yaml")

with open("output_data/template_document.json", "w") as f:
    json.dump(template.document, f, indent=4)
with open("output_data/template_elements.json", "w") as f:
    json.dump(template.elements, f, indent=4)
with open("output_data/template_sections.json", "w") as f:
    json.dump(template.sections, f, indent=4)
with open("output_data/technical_document.json", "w") as f:
    json.dump(technical.document, f, indent=4)#
with open("output_data/technical_elements.json", "w") as f:
...
with open("output_data/merged_elements.json", "w") as f:
    json.dump(merged, f, indent=4)
with open("output_data/mismatched_elements.json", "w") as f:
...
text += "</table>"
with open("output_data/mismatched_elements.html", "w") as f:
    f.write(text)
